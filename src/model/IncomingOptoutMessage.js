...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Winsms.IncomingOptoutMessage = factory(root.Winsms.ApiClient);
  }
  ...
  /**
   * The IncomingOptoutMessage model module.
   * @module model/IncomingOptoutMessage
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>IncomingOptoutMessage</code>.
   * @alias module:model/IncomingOptoutMessage
   * @class
   * @param incomingApiMessageId {Number} The unique API message id assigned to this incoming opt-out message. 
   * @param mobileNumber {String} The mobile number that sent the opt-out SMS message, displayed using the international E164 (without the plus) format 
   * @param receiveTime {Number} The date and time the message was received by WinSMS, in the format YYYYMMDDHHmm. 
   * @param messageText {String} The text of the opt-out SMS message. 
   */
  ...
  /**
   * Constructs a <code>IncomingOptoutMessage</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/IncomingOptoutMessage} obj Optional instance to populate.
   * @return {module:model/IncomingOptoutMessage} The populated <code>IncomingOptoutMessage</code> instance.
   */
