...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Winsms.MessageStatusResponse1 = factory(root.Winsms.ApiClient, root.Winsms.ScheduledMessage);
  }
  ...
  /**
   * The MessageStatusResponse1 model module.
   * @module model/MessageStatusResponse1
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>MessageStatusResponse1</code>.
   * @alias module:model/MessageStatusResponse1
   * @class
  ...
  /**
   * Constructs a <code>MessageStatusResponse1</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MessageStatusResponse1} obj Optional instance to populate.
   * @return {module:model/MessageStatusResponse1} The populated <code>MessageStatusResponse1</code> instance.
   */
