...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/MessageRecipientResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MessageRecipientResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Winsms) {
      root.Winsms = {};
    }
    root.Winsms.NewMessageResponse = factory(root.Winsms.ApiClient, root.Winsms.MessageRecipientResponse);
  }
}(this, function(ApiClient, MessageRecipientResponse) {
  'use strict';
   ...
   * @param recipients {Array.<module:model/MessageRecipientResponse>} An array of messageRecipientResponse objects
   */
  var exports = function(timeStamp, version, statusCode, recipients) {
    var _this = this;
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('recipients')) {
        obj['recipients'] = ApiClient.convertToType(data['recipients'], [MessageRecipientResponse]);
      }
    }
    return obj;
  }
   ...
   * @member {Array.<module:model/MessageRecipientResponse>} recipients
   */
