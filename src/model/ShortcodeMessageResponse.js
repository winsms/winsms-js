...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ShortcodeMessage'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ShortcodeMessage'));
  } else {
    // Browser globals (root is window)
    if (!root.Winsms) {
      root.Winsms = {};
    }
    root.Winsms.ShortcodeMessageResponse = factory(root.Winsms.ApiClient, root.Winsms.ShortcodeMessage);
  }
}(this, function(ApiClient, ShortcodeMessage) {
  'use strict';
  ...
  /**
   * The ShortcodeMessageResponse model module.
   * @module model/ShortcodeMessageResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ShortcodeMessageResponse</code>.
   * @alias module:model/ShortcodeMessageResponse
   * @class
   ...
   * @param shortcodeMessages {Array.<module:model/ShortcodeMessage>} An array of ***shortcodeMessage*** objects containing properties of each incoming shortcode message received by WinSMS. 
   */
  var exports = function(timeStamp, version, statusCode, resultsOffset, resultsLimit, resultsTotalAvailable, shortcodeMessages) {
    var _this = this;
    ...
    _this['shortcodeMessages'] = shortcodeMessages;
  };

  /**
   * Constructs a <code>ShortcodeMessageResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ShortcodeMessageResponse} obj Optional instance to populate.
   * @return {module:model/ShortcodeMessageResponse} The populated <code>ShortcodeMessageResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('shortcodeMessages')) {
        obj['shortcodeMessages'] = ApiClient.convertToType(data['shortcodeMessages'], [ShortcodeMessage]);
      }
    }
    return obj;
  }
   ...
   * @member {Array.<module:model/ShortcodeMessage>} shortcodeMessages
   */
  exports.prototype['shortcodeMessages'] = undefined;
